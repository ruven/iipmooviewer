...
Protocols.OpenSlide_DeepZoom = new Class({
  ...
  getThumbnailURL: function(server,image,width){
    ...
    // this assumes a url for the image which ends in .thumb which returns the thumbnail image
    return server+prefix+'.thumb';
  }
