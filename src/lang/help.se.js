IIPMooViewer.lang = {
	...
	'zoomOut': 'För att zooma ut: Använd shift + dubbelklick, musens rullningshjul, eller tryck på minustangenten',
	'rotate': 'För att rotera bilden medurs: Tryck på "r"-tangenten, för moturs: Använd shift + "r"-tangenten',
	'fullscreen': 'För helskärm: Tryck på "f"-tangenten',
	'annotations': 'För att växla mellan att visa/dölja förklaringarna: Tryck på "a"-tangenten',
	'navigation': 'För att visa/dölja navigeringsfönstret: Tryck på "h"-tangenten',
	'more': 'För ytterligare information besök',
